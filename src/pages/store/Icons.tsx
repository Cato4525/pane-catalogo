...
export const FlowerIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="none"><path d="M12 2C9.5 4.5 7 5 5 5c0 2 1 5 7 7-6 2-7 5-7 7 2 0 4.5-.5 7-3 2.5 2.5 5 3 7 3 0-2-1-5-7-7 6-2 7-5 7-7-2 0-4.5.5-7 3z"/></svg>
);
